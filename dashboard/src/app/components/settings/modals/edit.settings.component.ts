...
/*
 * Modal dialog for editing your existing Settings entity types, and/or
...
export class EditSettingsComponent {
   ...
   */
  private createColumns: string[] = ['name', 'value'];
  private updateColumns: string[] = ['name', 'value'];
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.settings_Put(this.data.entity).subscribe(res => {
      ...
      this.service.settings_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
