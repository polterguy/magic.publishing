...
import { EditUsersComponent } from './modals/edit.users.component';

/*
 * "Datagrid" component for displaying instance of Users
...
export class UsersComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['username', 'delete-instance'];
  ...
  ngOnInit() {
    ...
    this.username.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter['username.like'] = this.username.value + '%';
        this.getData();
      });
  }
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.users_Get(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.users_count_Get(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Users item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Users item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.users_Delete(ids).subscribe(res => {
