...
export class EditTemplatesComponent implements OnInit {
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditTemplatesComponent>,
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.templates_Put(this.data.entity).subscribe(res => {
      ...
      this.service.templates_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
