...
import { EditRolesComponent } from './modals/edit.roles.component';

/*
 * "Datagrid" component for displaying instance of Roles
...
export class RolesComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['name', 'description', 'delete-instance'];
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.roles_Get(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.roles_count_Get(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Roles item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Roles item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.roles_Delete(ids).subscribe(res => {
