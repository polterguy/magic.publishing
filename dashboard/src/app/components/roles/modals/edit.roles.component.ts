...
/*
 * Modal dialog for editing your existing Roles entity types, and/or
...
export class EditRolesComponent {
   ...
   */
  private createColumns: string[] = ['name', 'description'];
  private updateColumns: string[] = ['name', 'description'];
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.roles_Put(this.data.entity).subscribe(res => {
      ...
      this.service.roles_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
