...
/*
 * Modal dialog for editing your existing Item_types entity types, and/or
 * creating new entity types.
 */
@Component({
  templateUrl: './edit.item_types.component.html',
  styleUrls: ['./edit.item_types.component.scss']
})
export class EditItem_typesComponent {
   ...
   */
  private createColumns: string[] = ['name', 'root_resolve_url'];
  private updateColumns: string[] = ['name', 'root_resolve_url'];
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditItem_typesComponent>,
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.item_types_Put(this.data.entity).subscribe(res => {
      ...
      this.service.item_types_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
