...
import { EditItemsComponent } from './modals/edit.items.component';

/*
 * "Datagrid" component for displaying instance of Items
...
export class ItemsComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['title', 'item_type', 'author', 'created', 'template', 'delete-instance'];
  ...
  ngOnInit() {
    ...
    this.url.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['url.like'] = this.url.value + '%';
        this.getData();
      });
    ...
    this.author.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['author.like'] = this.author.value + '%';
        this.getData();
      });
    ...
    this.template.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['template.like'] = this.template.value + '%';
        this.getData();
      });
    this.item_type = new FormControl('');
    this.item_type.valueChanges
      .pipe(debounceTime(this.debounce), distinctUntilChanged())
      .subscribe(query => {
        this.paginator.pageIndex = 0;
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['item_type.like'] = this.item_type.value + '%';
        this.getData();
      });
    ...
    this.title.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['title.like'] = this.title.value + '%';
        this.getData();
      });
    ...
    this.content.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['content.like'] = this.content.value + '%';
        this.getData();
      });
  }
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.items_Get(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.items_count_Get(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Items item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Items item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.items_Delete(ids).subscribe(res => {
